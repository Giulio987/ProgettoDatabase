...
<body>
  <div class="container">
    ...
    <div class="interno col md-12 text-center" >
      <!--RECUPERA IL NUMERO DI COPIE DEL LIBRO DISPONIBILI E IN QUALI DIPPARTIMENTI ESSE SI TROVANO -->
      <form action="<?=$_SERVER['PHP_SELF'];?>" method="POST" id='form' class= 'loader'>
        ...
        if(isset($_POST['Valore'])){
          ...
          //SOTTRAZIONE SIMULATA CON LA LEFT JOIN
          ...
          FROM (SELECT X.ISBN, X.NUMERO_COPIA, X.NOME_DIP FROM(SELECT ISBN,NUMERO_COPIA, NOME_DIP
            ...
            if(!$resultC){
              echo "<br>Ricerca Fallita".$resultC."<br>".$connection->error."<br>";
            }
        ...
        $(document).ready(function() {
          //COLLAPSIBLE che all'apertura di unochiude gli altri
        ...
        <!--RICERCA PER OGNI DIPARTIMENTO IL NUMERO DI LIBRI(E VARIE COPIE RELATIVE AL LIBRO) IN ESSO PRESENTI -->
        <div class="collapse" id="libridip">
          <div class="card card-body">
            ...
            if(!$result){
              echo "<br>Ricerca Libri per dipartimenti Fallita".$result."<br>".$connection->error."<br>";
            }
            echo "
        ...
        <!--SCADENZE IMMINENTI A CUI MANCANO 3 GIORNI -->
        <div class="collapse" id="scadenze">
          <div class="card card-body">
            ...
            if(!$result){
              echo "<br>Ricerca Scadenze Imminenti Fallita".$result."<br>".$connection->error."<br>";
            }
            echo "
            <table class=\"table\">
